...
const ALLOWED_PRICES = [
  "price_1T3D1eQOEsasHN6b1ns5Pbwi",
  "price_1T3D2DQOEsasHN6bPwZbJjpZ",
];
...
async (req, res) => {
  ...
  if (event.type === "checkout.session.completed") {
    ...
    // fallback — беремо metadata з subscription
...
async (request) => {
  ...
  const origin =
    allowedOrigins.find(o => referer.startsWith(o))
    || "http://localhost:5173";
