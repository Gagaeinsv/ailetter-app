          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center bg-[#1e293b] rounded-lg p-0.5 border border-[#334155] ml-2">
              ...
              <button
                ...
                disabled={!generatedLetter}
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all disabled:opacity-30 ${
                  isPro ? 'text-indigo-400 hover:bg-indigo-500/10' : 'text-amber-400 hover:text-amber-300'
                }`}
              >
