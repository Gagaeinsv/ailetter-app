    ...
    <div className="h-full overflow-y-auto bg-[#0f172a] px-4 py-6 pb-24 custom-scrollbar text-white">
      ...
      {cvAnalysis && !cvAnalysisLoading && (
        <div className="space-y-4 mb-6">
          ...
          <div className="bg-[#1e293b]/30 rounded-xl border border-white/5 p-4">
            <div className="flex flex-col gap-3 mb-3 border-b border-white/5 pb-3">
              <div className="flex items-center gap-2">
                <Sparkles className="text-amber-400 w-4.5 h-4.5 shrink-0" />
                <div>
                  <h3 className="font-black text-[10px] uppercase tracking-widest text-gray-300">
              ...
              <div className="flex items-center gap-2 w-full">
                <button
                  ...
                  className="flex-1 py-2 bg-[#1e293b] hover:bg-[#334155] border border-white/5 text-white rounded-lg text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-1 transition-all active:scale-[0.98]"
                >
                ...
                <button
                  ...
                  className="flex-1 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-1 transition-all active:scale-[0.98] shadow-md shadow-indigo-500/20"
                >
