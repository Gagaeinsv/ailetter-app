    ...
    <div className="w-full">
      ...
      {generatedLetter && jobDescription && (
        <div className="px-4 pb-4 space-y-4 border-b border-[#1e293b] bg-[#0f172a]">
          ...
          <ATSScore coverLetter={generatedLetter} jobDescription={jobDescription} triggerKey={atsKey} dict={dict} onIntegrateKeyword={handleIntegrateKeyword} />
        </div>
      )}
...
export default MobileCoverLetterTab;
